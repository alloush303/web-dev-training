...
function Dashboard() {
    ...
    return (
        <div className={`${theme === 'light' ? 'container-light' : 'container-dark'} dashboard-container vh-100 overflow-hidden d-flex flex-column`}>
            ...
            <div className="row flex-grow-1  overflow-hidden w-100">
                <div className="sideBar h-100 col-2 justify-content-center text-center p-5">
                    <nav className={`${theme === 'light' ? 'nav-light' : 'nav-dark'} d-flex flex-column  gap-4`}>
