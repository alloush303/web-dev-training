...
function Dashboard() {
    return (
        <div className="dashboard-container vh-100 overflow-hidden">
            ...
            <div className="row">
                <div className="sideBar vh-100 col-2 justify-content-center text-center p-5">
                ...
                <div className="col-10 vh-100 p-4">
                    <div>
                        <Outlet />
