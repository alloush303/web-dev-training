...
function Welcome() {
    ...
    return (
        <div className='welcom-container d-flex flex-column justify-content-center align-items-center vh-100 text-center'>
            <div className="card-box box w-50 p-3 rounded-5">
